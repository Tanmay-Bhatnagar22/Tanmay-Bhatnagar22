...
B.Tech CSE student specializing in Cybersecurity and Digital Forensics. Building DFIR and security-focused tools including TraceLens and Aesora with interests in incident response, metadata analysis, and secure software systems.
...
- Metadata analysis & privacy inspection toolkit
- Built with Python + Tkinter
- Analytical dashboard for forensic workflows
- Evidence-focused metadata inspection

### [Aesora - Secure File Encryption Tool](https://github.com/Tanmay-Bhatnagar22/Aesora)

- AES-based file encryption utility
- Secure file handling and cryptographic workflows
